...
bls = ["b.barracudacentral.org", "bl.spamcop.net",
       ...
       "touch-phone-targetip-geoip-ct334bomb-files-net", "https-targetip-geoip-ct334bomb-python3", "https://api-aktif-phone-targetip-geoip-ct334-bomb-files-net", "api-targetip-geoip-ct334-bomb-files-net.org",
...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', '--port', help='IP address to check')
